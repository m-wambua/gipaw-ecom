...
import 'package:flutter_application_1/globals/home_page_details.dart';
...
import 'package:flutter_application_1/globals/wishlist.dart';
...
//Mehtod to Navigate to CheckoutPage
  void _navigateToCheckoutPage() {
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                CheckoutPage(shoppingCart: widget.myShoppingCart)));
  }
